...
The system relies on \texttt{Duncaen/OpenDoas}, enforcing:
...
\toprule\textbf{Security Parameter} & \textbf{Standard Enterprise Linux (GNU/systemd)} & \textbf{SEC-LINE OS (zencrypted/os)} \\
